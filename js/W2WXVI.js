...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXVI = localStorage.getItem("lastTabW2WXVI");
		if (lastTabW2WXVI) {
			switch (lastTabW2WXVI) {
				case "Cover":
					localStorage.setItem("coverTabW2WXVIIsActive", true);
					localStorage.setItem("authorTabW2WXVIIsActive", false);
					localStorage.setItem("dedTabW2WXVIIsActive", false);
					localStorage.setItem("chapterTabW2WXVIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXVIIsActive", false);
					localStorage.setItem("authorTabW2WXVIIsActive", true);
					localStorage.setItem("dedTabW2WXVIIsActive", false);
					localStorage.setItem("chapterTabW2WXVIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXVIIsActive", false);
					localStorage.setItem("authorTabW2WXVIIsActive", false);
					localStorage.setItem("dedTabW2WXVIIsActive", true);
					localStorage.setItem("chapterTabW2WXVIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXVIIsActive", false);
					localStorage.setItem("dedTabW2WXVIIsActive", false);
					localStorage.setItem("chapterTabW2WXVIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXVI = localStorage.setItem("lastTabW2WXVI", "Cover");
			localStorage.setItem("coverTabW2WXVIIsActive", true);
			localStorage.setItem("authorTabW2WXVIIsActive", false);
			localStorage.setItem("dedTabW2WXVIIsActive", false);
			localStorage.setItem("chapterTabW2WXVIIsActive", false);
