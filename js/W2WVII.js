...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WVII = localStorage.getItem("lastTabW2WVII");
		if (lastTabW2WVII) {
			switch (lastTabW2WVII) {
				case "Cover":
					localStorage.setItem("coverTabW2WVIIIsActive", true);
					localStorage.setItem("authorTabW2WVIIIsActive", false);
					localStorage.setItem("dedTabW2WVIIIsActive", false);
					localStorage.setItem("chapterTabW2WVIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WVIIIsActive", false);
					localStorage.setItem("authorTabW2WVIIIsActive", true);
					localStorage.setItem("dedTabW2WVIIIsActive", false);
					localStorage.setItem("chapterTabW2WVIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WVIIIsActive", false);
					localStorage.setItem("authorTabW2WVIIIsActive", false);
					localStorage.setItem("dedTabW2WVIIIsActive", true);
					localStorage.setItem("chapterTabW2WVIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WVIIIsActive", false);
					localStorage.setItem("dedTabW2WVIIIsActive", false);
					localStorage.setItem("chapterTabW2WVIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WVII = localStorage.setItem("lastTabW2WVII", "Cover");
			localStorage.setItem("coverTabW2WVIIIsActive", true);
			localStorage.setItem("authorTabW2WVIIIsActive", false);
			localStorage.setItem("dedTabW2WVIIIsActive", false);
			localStorage.setItem("chapterTabW2WVIIIsActive", false);
