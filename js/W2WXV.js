...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXV = localStorage.getItem("lastTabW2WXV");
		if (lastTabW2WXV) {
			switch (lastTabW2WXV) {
				case "Cover":
					localStorage.setItem("coverTabW2WXVIsActive", true);
					localStorage.setItem("authorTabW2WXVIsActive", false);
					localStorage.setItem("dedTabW2WXVIsActive", false);
					localStorage.setItem("chapterTabW2WXVIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXVIsActive", false);
					localStorage.setItem("authorTabW2WXVIsActive", true);
					localStorage.setItem("dedTabW2WXVIsActive", false);
					localStorage.setItem("chapterTabW2WXVIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXVIsActive", false);
					localStorage.setItem("authorTabW2WXVIsActive", false);
					localStorage.setItem("dedTabW2WXVIsActive", true);
					localStorage.setItem("chapterTabW2WXVIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXVIsActive", false);
					localStorage.setItem("dedTabW2WXVIsActive", false);
					localStorage.setItem("chapterTabW2WXVIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXV = localStorage.setItem("lastTabW2WXV", "Cover");
			localStorage.setItem("coverTabW2WXVIsActive", true);
			localStorage.setItem("authorTabW2WXVIsActive", false);
			localStorage.setItem("dedTabW2WXVIsActive", false);
			localStorage.setItem("chapterTabW2WXVIsActive", false);
