...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WVI = localStorage.getItem("lastTabW2WVI");
		if (lastTabW2WVI) {
			switch (lastTabW2WVI) {
				case "Cover":
					localStorage.setItem("coverTabW2WVIIsActive", true);
					localStorage.setItem("authorTabW2WVIIsActive", false);
					localStorage.setItem("dedTabW2WVIIsActive", false);
					localStorage.setItem("chapterTabW2WVIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WVIIsActive", false);
					localStorage.setItem("authorTabW2WVIIsActive", true);
					localStorage.setItem("dedTabW2WVIIsActive", false);
					localStorage.setItem("chapterTabW2WVIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WVIIsActive", false);
					localStorage.setItem("authorTabW2WVIIsActive", false);
					localStorage.setItem("dedTabW2WVIIsActive", true);
					localStorage.setItem("chapterTabW2WVIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WVIIsActive", false);
					localStorage.setItem("dedTabW2WVIIsActive", false);
					localStorage.setItem("chapterTabW2WVIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WVI = localStorage.setItem("lastTabW2WVI", "Cover");
			localStorage.setItem("coverTabW2WVIIsActive", true);
			localStorage.setItem("authorTabW2WVIIsActive", false);
			localStorage.setItem("dedTabW2WVIIsActive", false);
			localStorage.setItem("chapterTabW2WVIIsActive", false);
