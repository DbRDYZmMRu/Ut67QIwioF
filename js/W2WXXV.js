...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXXV = localStorage.getItem("lastTabW2WXXV");
		if (lastTabW2WXXV) {
			switch (lastTabW2WXXV) {
				case "Cover":
					localStorage.setItem("coverTabW2WXXVIsActive", true);
					localStorage.setItem("authorTabW2WXXVIsActive", false);
					localStorage.setItem("dedTabW2WXXVIsActive", false);
					localStorage.setItem("chapterTabW2WXXVIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXXVIsActive", false);
					localStorage.setItem("authorTabW2WXXVIsActive", true);
					localStorage.setItem("dedTabW2WXXVIsActive", false);
					localStorage.setItem("chapterTabW2WXXVIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXXVIsActive", false);
					localStorage.setItem("authorTabW2WXXVIsActive", false);
					localStorage.setItem("dedTabW2WXXVIsActive", true);
					localStorage.setItem("chapterTabW2WXXVIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXXVIsActive", false);
					localStorage.setItem("dedTabW2WXXVIsActive", false);
					localStorage.setItem("chapterTabW2WXXVIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXXV = localStorage.setItem("lastTabW2WXXV", "Cover");
			localStorage.setItem("coverTabW2WXXVIsActive", true);
			localStorage.setItem("authorTabW2WXXVIsActive", false);
			localStorage.setItem("dedTabW2WXXVIsActive", false);
			localStorage.setItem("chapterTabW2WXXVIsActive", false);
