...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXIV = localStorage.getItem("lastTabW2WXIV");
		if (lastTabW2WXIV) {
			switch (lastTabW2WXIV) {
				case "Cover":
					localStorage.setItem("coverTabW2WXIVIsActive", true);
					localStorage.setItem("authorTabW2WXIVIsActive", false);
					localStorage.setItem("dedTabW2WXIVIsActive", false);
					localStorage.setItem("chapterTabW2WXIVIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXIVIsActive", false);
					localStorage.setItem("authorTabW2WXIVIsActive", true);
					localStorage.setItem("dedTabW2WXIVIsActive", false);
					localStorage.setItem("chapterTabW2WXIVIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXIVIsActive", false);
					localStorage.setItem("authorTabW2WXIVIsActive", false);
					localStorage.setItem("dedTabW2WXIVIsActive", true);
					localStorage.setItem("chapterTabW2WXIVIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXIVIsActive", false);
					localStorage.setItem("dedTabW2WXIVIsActive", false);
					localStorage.setItem("chapterTabW2WXIVIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXIV = localStorage.setItem("lastTabW2WXIV", "Cover");
			localStorage.setItem("coverTabW2WXIVIsActive", true);
			localStorage.setItem("authorTabW2WXIVIsActive", false);
			localStorage.setItem("dedTabW2WXIVIsActive", false);
			localStorage.setItem("chapterTabW2WXIVIsActive", false);
