...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXIII = localStorage.getItem("lastTabW2WXIII");
		if (lastTabW2WXIII) {
			switch (lastTabW2WXIII) {
				case "Cover":
					localStorage.setItem("coverTabW2WXIIIIsActive", true);
					localStorage.setItem("authorTabW2WXIIIIsActive", false);
					localStorage.setItem("dedTabW2WXIIIIsActive", false);
					localStorage.setItem("chapterTabW2WXIIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXIIIIsActive", false);
					localStorage.setItem("authorTabW2WXIIIIsActive", true);
					localStorage.setItem("dedTabW2WXIIIIsActive", false);
					localStorage.setItem("chapterTabW2WXIIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXIIIIsActive", false);
					localStorage.setItem("authorTabW2WXIIIIsActive", false);
					localStorage.setItem("dedTabW2WXIIIIsActive", true);
					localStorage.setItem("chapterTabW2WXIIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXIIIIsActive", false);
					localStorage.setItem("dedTabW2WXIIIIsActive", false);
					localStorage.setItem("chapterTabW2WXIIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXIII = localStorage.setItem("lastTabW2WXIII", "Cover");
			localStorage.setItem("coverTabW2WXIIIIsActive", true);
			localStorage.setItem("authorTabW2WXIIIIsActive", false);
			localStorage.setItem("dedTabW2WXIIIIsActive", false);
			localStorage.setItem("chapterTabW2WXIIIIsActive", false);
