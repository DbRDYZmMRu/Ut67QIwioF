...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXXIV = localStorage.getItem("lastTabW2WXXIV");
		if (lastTabW2WXXIV) {
			switch (lastTabW2WXXIV) {
				case "Cover":
					localStorage.setItem("coverTabW2WXXIVIsActive", true);
					localStorage.setItem("authorTabW2WXXIVIsActive", false);
					localStorage.setItem("dedTabW2WXXIVIsActive", false);
					localStorage.setItem("chapterTabW2WXXIVIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXXIVIsActive", false);
					localStorage.setItem("authorTabW2WXXIVIsActive", true);
					localStorage.setItem("dedTabW2WXXIVIsActive", false);
					localStorage.setItem("chapterTabW2WXXIVIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXXIVIsActive", false);
					localStorage.setItem("authorTabW2WXXIVIsActive", false);
					localStorage.setItem("dedTabW2WXXIVIsActive", true);
					localStorage.setItem("chapterTabW2WXXIVIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXXIVIsActive", false);
					localStorage.setItem("dedTabW2WXXIVIsActive", false);
					localStorage.setItem("chapterTabW2WXXIVIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXXIV = localStorage.setItem("lastTabW2WXXIV", "Cover");
			localStorage.setItem("coverTabW2WXXIVIsActive", true);
			localStorage.setItem("authorTabW2WXXIVIsActive", false);
			localStorage.setItem("dedTabW2WXXIVIsActive", false);
			localStorage.setItem("chapterTabW2WXXIVIsActive", false);
