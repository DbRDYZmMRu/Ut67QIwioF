...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXXII = localStorage.getItem("lastTabW2WXXII");
		if (lastTabW2WXXII) {
			switch (lastTabW2WXXII) {
				case "Cover":
					localStorage.setItem("coverTabW2WXXIIIsActive", true);
					localStorage.setItem("authorTabW2WXXIIIsActive", false);
					localStorage.setItem("dedTabW2WXXIIIsActive", false);
					localStorage.setItem("chapterTabW2WXXIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXXIIIsActive", false);
					localStorage.setItem("authorTabW2WXXIIIsActive", true);
					localStorage.setItem("dedTabW2WXXIIIsActive", false);
					localStorage.setItem("chapterTabW2WXXIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXXIIIsActive", false);
					localStorage.setItem("authorTabW2WXXIIIsActive", false);
					localStorage.setItem("dedTabW2WXXIIIsActive", true);
					localStorage.setItem("chapterTabW2WXXIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXXIIIsActive", false);
					localStorage.setItem("dedTabW2WXXIIIsActive", false);
					localStorage.setItem("chapterTabW2WXXIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXXII = localStorage.setItem("lastTabW2WXXII", "Cover");
			localStorage.setItem("coverTabW2WXXIIIsActive", true);
			localStorage.setItem("authorTabW2WXXIIIsActive", false);
			localStorage.setItem("dedTabW2WXXIIIsActive", false);
			localStorage.setItem("chapterTabW2WXXIIIsActive", false);
