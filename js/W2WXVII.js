...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXVII = localStorage.getItem("lastTabW2WXVII");
		if (lastTabW2WXVII) {
			switch (lastTabW2WXVII) {
				case "Cover":
					localStorage.setItem("coverTabW2WXVIIIsActive", true);
					localStorage.setItem("authorTabW2WXVIIIsActive", false);
					localStorage.setItem("dedTabW2WXVIIIsActive", false);
					localStorage.setItem("chapterTabW2WXVIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXVIIIsActive", false);
					localStorage.setItem("authorTabW2WXVIIIsActive", true);
					localStorage.setItem("dedTabW2WXVIIIsActive", false);
					localStorage.setItem("chapterTabW2WXVIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXVIIIsActive", false);
					localStorage.setItem("authorTabW2WXVIIIsActive", false);
					localStorage.setItem("dedTabW2WXVIIIsActive", true);
					localStorage.setItem("chapterTabW2WXVIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXVIIIsActive", false);
					localStorage.setItem("dedTabW2WXVIIIsActive", false);
					localStorage.setItem("chapterTabW2WXVIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXVII = localStorage.setItem("lastTabW2WXVII", "Cover");
			localStorage.setItem("coverTabW2WXVIIIsActive", true);
			localStorage.setItem("authorTabW2WXVIIIsActive", false);
			localStorage.setItem("dedTabW2WXVIIIsActive", false);
			localStorage.setItem("chapterTabW2WXVIIIsActive", false);
