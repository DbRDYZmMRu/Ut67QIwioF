...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WVIII = localStorage.getItem("lastTabW2WVIII");
		if (lastTabW2WVIII) {
			switch (lastTabW2WVIII) {
				case "Cover":
					localStorage.setItem("coverTabW2WVIIIIsActive", true);
					localStorage.setItem("authorTabW2WVIIIIsActive", false);
					localStorage.setItem("dedTabW2WVIIIIsActive", false);
					localStorage.setItem("chapterTabW2WVIIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WVIIIIsActive", false);
					localStorage.setItem("authorTabW2WVIIIIsActive", true);
					localStorage.setItem("dedTabW2WVIIIIsActive", false);
					localStorage.setItem("chapterTabW2WVIIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WVIIIIsActive", false);
					localStorage.setItem("authorTabW2WVIIIIsActive", false);
					localStorage.setItem("dedTabW2WVIIIIsActive", true);
					localStorage.setItem("chapterTabW2WVIIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WVIIIIsActive", false);
					localStorage.setItem("dedTabW2WVIIIIsActive", false);
					localStorage.setItem("chapterTabW2WVIIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WVIII = localStorage.setItem("lastTabW2WVIII", "Cover");
			localStorage.setItem("coverTabW2WVIIIIsActive", true);
			localStorage.setItem("authorTabW2WVIIIIsActive", false);
			localStorage.setItem("dedTabW2WVIIIIsActive", false);
			localStorage.setItem("chapterTabW2WVIIIIsActive", false);
