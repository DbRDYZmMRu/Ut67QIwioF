...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXXIII = localStorage.getItem("lastTabW2WXXIII");
		if (lastTabW2WXXIII) {
			switch (lastTabW2WXXIII) {
				case "Cover":
					localStorage.setItem("coverTabW2WXXIIIIsActive", true);
					localStorage.setItem("authorTabW2WXXIIIIsActive", false);
					localStorage.setItem("dedTabW2WXXIIIIsActive", false);
					localStorage.setItem("chapterTabW2WXXIIIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXXIIIIsActive", false);
					localStorage.setItem("authorTabW2WXXIIIIsActive", true);
					localStorage.setItem("dedTabW2WXXIIIIsActive", false);
					localStorage.setItem("chapterTabW2WXXIIIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXXIIIIsActive", false);
					localStorage.setItem("authorTabW2WXXIIIIsActive", false);
					localStorage.setItem("dedTabW2WXXIIIIsActive", true);
					localStorage.setItem("chapterTabW2WXXIIIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXXIIIIsActive", false);
					localStorage.setItem("dedTabW2WXXIIIIsActive", false);
					localStorage.setItem("chapterTabW2WXXIIIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXXIII = localStorage.setItem("lastTabW2WXXIII", "Cover");
			localStorage.setItem("coverTabW2WXXIIIIsActive", true);
			localStorage.setItem("authorTabW2WXXIIIIsActive", false);
			localStorage.setItem("dedTabW2WXXIIIIsActive", false);
			localStorage.setItem("chapterTabW2WXXIIIIsActive", false);
