...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WIX = localStorage.getItem("lastTabW2WIX");
		if (lastTabW2WIX) {
			switch (lastTabW2WIX) {
				case "Cover":
					localStorage.setItem("coverTabW2WIXIsActive", true);
					localStorage.setItem("authorTabW2WIXIsActive", false);
					localStorage.setItem("dedTabW2WIXIsActive", false);
					localStorage.setItem("chapterTabW2WIXIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WIXIsActive", false);
					localStorage.setItem("authorTabW2WIXIsActive", true);
					localStorage.setItem("dedTabW2WIXIsActive", false);
					localStorage.setItem("chapterTabW2WIXIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WIXIsActive", false);
					localStorage.setItem("authorTabW2WIXIsActive", false);
					localStorage.setItem("dedTabW2WIXIsActive", true);
					localStorage.setItem("chapterTabW2WIXIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WIXIsActive", false);
					localStorage.setItem("dedTabW2WIXIsActive", false);
					localStorage.setItem("chapterTabW2WIXIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WIX = localStorage.setItem("lastTabW2WIX", "Cover");
			localStorage.setItem("coverTabW2WIXIsActive", true);
			localStorage.setItem("authorTabW2WIXIsActive", false);
			localStorage.setItem("dedTabW2WIXIsActive", false);
			localStorage.setItem("chapterTabW2WIXIsActive", false);
