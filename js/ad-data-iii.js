...
}, 
{
  ...
  duration: 12,
  cta: {
    message: `Just Dropped: New Essentials. An all-new collection of must-haves—including the sexiest Milky Sheer intimates and comfiest Cotton Jersey basics.<br><br>

Kim Kardashian wears the Milky Sheer String Bikini, size S, and Cotton Jersey Long Sleeve T-Shirt, size XS, in Soot.`,
