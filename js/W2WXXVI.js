...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXXVI = localStorage.getItem("lastTabW2WXXVI");
		if (lastTabW2WXXVI) {
			switch (lastTabW2WXXVI) {
				case "Cover":
					localStorage.setItem("coverTabW2WXXVIIsActive", true);
					localStorage.setItem("authorTabW2WXXVIIsActive", false);
					localStorage.setItem("dedTabW2WXXVIIsActive", false);
					localStorage.setItem("chapterTabW2WXXVIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXXVIIsActive", false);
					localStorage.setItem("authorTabW2WXXVIIsActive", true);
					localStorage.setItem("dedTabW2WXXVIIsActive", false);
					localStorage.setItem("chapterTabW2WXXVIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXXVIIsActive", false);
					localStorage.setItem("authorTabW2WXXVIIsActive", false);
					localStorage.setItem("dedTabW2WXXVIIsActive", true);
					localStorage.setItem("chapterTabW2WXXVIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXXVIIsActive", false);
					localStorage.setItem("dedTabW2WXXVIIsActive", false);
					localStorage.setItem("chapterTabW2WXXVIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXXVI = localStorage.setItem("lastTabW2WXXVI", "Cover");
			localStorage.setItem("coverTabW2WXXVIIsActive", true);
			localStorage.setItem("authorTabW2WXXVIIsActive", false);
			localStorage.setItem("dedTabW2WXXVIIsActive", false);
			localStorage.setItem("chapterTabW2WXXVIIsActive", false);
