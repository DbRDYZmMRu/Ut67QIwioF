...
if (_lorder.length > 0) {
  setTimeout(function() {
    _lorder.fadeOut(100);
		...
		let lastTabW2WXXI = localStorage.getItem("lastTabW2WXXI");
		if (lastTabW2WXXI) {
			switch (lastTabW2WXXI) {
				case "Cover":
					localStorage.setItem("coverTabW2WXXIIsActive", true);
					localStorage.setItem("authorTabW2WXXIIsActive", false);
					localStorage.setItem("dedTabW2WXXIIsActive", false);
					localStorage.setItem("chapterTabW2WXXIIsActive", false);
					$('#pills-trekking-tab').click();
					break;
				case "Author":
					localStorage.setItem("coverTabW2WXXIIsActive", false);
					localStorage.setItem("authorTabW2WXXIIsActive", true);
					localStorage.setItem("dedTabW2WXXIIsActive", false);
					localStorage.setItem("chapterTabW2WXXIIsActive", false);
				...
				case "Dedication":
					localStorage.setItem("coverTabW2WXXIIsActive", false);
					localStorage.setItem("authorTabW2WXXIIsActive", false);
					localStorage.setItem("dedTabW2WXXIIsActive", true);
					localStorage.setItem("chapterTabW2WXXIIsActive", false);
				...
				case "Chapters":
					...
					localStorage.setItem("authorTabW2WXXIIsActive", false);
					localStorage.setItem("dedTabW2WXXIIsActive", false);
					localStorage.setItem("chapterTabW2WXXIIsActive", true);
					$('#pills-integration-tab').click();
			}
		} else {
			lastTabW2WXXI = localStorage.setItem("lastTabW2WXXI", "Cover");
			localStorage.setItem("coverTabW2WXXIIsActive", true);
			localStorage.setItem("authorTabW2WXXIIsActive", false);
			localStorage.setItem("dedTabW2WXXIIsActive", false);
			localStorage.setItem("chapterTabW2WXXIIsActive", false);
